    ...
    <Card>
      <Grid container spacing={6}>
        ...
        <Grid item sm={5} xs={12}>
          <CardContent>
            <Carousel autoPlay infiniteLoop showThumbs={false} ref={ref} className={styles.carousel}>
              <div className={styles.importimg}></div>
              <div className={styles.importimg1}></div>
              <div className={styles.importimg2}></div>
              <div className={styles.importimg3}></div>
            </Carousel>
